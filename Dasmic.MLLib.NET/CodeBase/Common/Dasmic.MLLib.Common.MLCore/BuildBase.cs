...
namespace Dasmic.MLLib.Common.MLCore
{
    public abstract class BuildBase: IBuildModel
    {
        ...
        /// <returns></returns>
        protected int[] GetUniqueRandomNumbers(int min,
            int max, int count)
        {
        ...
        /// 
        /// This function is also duplicates in ArrayManipulation class
        /// </summary>
        /// <param name="columns">Number of columns</param>
        /// <param name="rows">Number of rows</param>
        protected double[][] Get2DArray(int columns, int rows)
        {
            ArrayManipulation.Get2DArray(columns, rows, _maxParallelThreads);
        ...
        /// <returns></returns>
        public double[] GetLinearArray(double [][] mainArray,int mainArrayRowIdx,int endColumnIdx)
        {
        ...
        /// <returns></returns>
        public virtual bool BuildModelSingle(
            double[][][] trainingData,
        ...
        public virtual void InitializeModel(int inputDepth,
                                int inputColumns,
                                int inputRows,
                                int padding,
