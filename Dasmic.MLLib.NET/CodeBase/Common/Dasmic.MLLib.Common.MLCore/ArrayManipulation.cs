...
namespace Dasmic.MLLib.Common.MLCore
{
    public static class ArrayManipulation
    {
        ...
        public static double[][] Get2DArray(int columns, int rows, int maxParallelThreads)
        {
            double[][] newArray = new double[columns][];
            //for (int col=0;col<rows;col++)
            Parallel.For(0, columns, new ParallelOptions { MaxDegreeOfParallelism = maxParallelThreads }, col =>
            {
