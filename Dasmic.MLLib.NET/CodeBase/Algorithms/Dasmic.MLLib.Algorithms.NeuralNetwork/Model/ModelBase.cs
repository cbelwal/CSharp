...
namespace Dasmic.MLLib.Algorithms.NeuralNetwork
{
    public abstract class ModelBase : MLLib.Common.MLCore.ModelBase
    {
        ...
        public void AddLayer(int layerIdx, int numberOfUnits, double weightInitValue,
        ...
        public double GetWeight(int idxLayer,int idxUpUnit, int idxUnit)
        {
            return _layers[idxLayer].Weights[idxUpUnit][idxUnit];
        }

        public void SetWeight(int idxLayer, int idxUpUnit, int idxUnit, double value)
        {
            _layers[idxLayer].Weights[idxUpUnit][idxUnit] = value;
        }


        public int GetNumberOfUnits(int idxLayer)
        {
        ...
        /// <returns></returns>
        public int GetNumberOfUpstreamUnits(int idxLayer)
        {
            return _layers[idxLayer].GetNumberOfUpstreamUnits();
        }

        public double GetUpstreamUnitValue(int idxLayer, int idxUpUnit,int row)
        {
            return _layers[idxLayer].GetValueUpstreamLayer(idxUpUnit,row);
        }

        public double GetUnitValue(int idxLayer, int idxUnit, int row)
        {
        ...
        public double GetOutputTillLayer(int idxUptillLayer, int idxUnit,int row)
        {
        ...
        public double GetOutput(int unitIdx, int row)
        {
            double[] computedValues =
                GetOutput(row);
        ...
        /// <returns></returns>
        public double[] GetNeuralNetworkOutputForSingleDataRow(int dataRow)
        {
                            ...
                            int dataRow)
        {
            ...
            int lastLayerNoOfUnits = lastLayer.GetNumberOfUnits();
