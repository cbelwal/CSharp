...
namespace Dasmic.MLLib.Algorithms.DecisionTree
{
    public class BuildCART:BuildBase
    {
        ...
        protected int _numberOfFeaturesForSplit;
        protected int[] _splitFeatures;

        public BuildCART()
        {
            _numberOfFeaturesForSplit = int.MaxValue;
        }
        ...
        public void SetParametersForRandomForest(int numberOfFeaturesForSplit)
        {
        ...
        protected ConcurrentBag<int> 
                    GetTrainingDataForAllRows(double[][] trainingData)
        {
            ConcurrentBag<int> trainingDataRowIndices =
                        new ConcurrentBag<int>();

            for (int idx = 0; idx < trainingData[0].Length; idx++)
        ...
        protected DecisionTreeNode BuildChildNodes(ConcurrentBag<int> trainingDataRowIndices,
                                                   double value,
                                                   ...
                                                   bool isLessThan)
        {
            ...
            ConcurrentBag<int> newTrainingDataRowIndices =
        ...
        {            
            ...
            //foreach (int rowIdx in trainingDataRowIndices) //Can optimize here to view rows passed down
        ...
        protected void CopyFilteredData(List<double>[] filteredValues,int rowIdx)
        {
            for (int colIdx = 0; colIdx < _trainingData.Length; colIdx++)
            {
        ...
        {                    
            if (_numberOfFeaturesForSplit == int.MaxValue ||
