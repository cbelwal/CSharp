...
namespace Dasmic.MLLib.Algorithms.SupportVectorMachine
{
    ...
    public class SequentialMinimalOptimization
    {
        ...
        /// <param name="i2"></param>
        /// <returns></returns>
        private int examineExample(int row2)
        {
            //double[] i2 =
            ...
            if ((r2 < -_tolerance && alph2 < _C) || (r2 > _tolerance && alph2 > 0))
            {
                ...
                for (int row=startIdx;row<_lagrangeMul.Length;row++)
                {
        ...
        private bool takeStep(int row1, int row2)
        {
        ...
        /// <param name="a2"></param>
        /// <param name="y2"></param>
        private void updateErrorCache(int row1,double alph1, double a1, double y1, 
                                      int row2,double alph2, double a2, double y2)
        {
        ...
        private double getError(int row)
        {
            double E;
        ...
        /// <returns></returns>
        private double getLearnedFunctionValue(int row)
        {
            double value=0;
        ...
        /// </summary>
        /// <returns></returns>
        private int getRowForSecondChoiceHeuristic(double E2)
        {
            int k, idx;
            double tmax;
            double E1, tmp;
        ...
        private double getL(int row1, int row2)
        {
            double L;
        ...
        private double getH(int row1, int row2)
        {
            double H;
            double alpha1 = _lagrangeMul[row1];
            double alpha2 = _lagrangeMul[row2];
        ...
        private double computeKernel(int row1,int row2)
        {
            double value = 0;
