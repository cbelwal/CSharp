...
{
    [TestClass]
    public class GenericBackPropagationSGDTest : BaseTest
    {
    #region Training Data from Jason Gaussian Naive Bayes

        [TestMethod]
        public void NN_backpropagation_generic_sgd_gnb_single_training_sample_class_0()
        {
            initData_dataset_gaussian_naive_bayes_jason_example();
            BuildGenericBackPropagationSGD build =
                    new BuildGenericBackPropagationSGD();
        ...
        [TestMethod]
        public void NN_backpropagation_generic_sgd_gnb_all_training_samples()
        {
            initData_dataset_gaussian_naive_bayes_jason_example();
            BuildGenericBackPropagationSGD build =
                    new BuildGenericBackPropagationSGD();
        ...
        [TestMethod]
        public void NN_backpropagation_generic_sgd_3L_gnb_all_training_samples()
        {
            initData_dataset_gaussian_naive_bayes_jason_example();
            BuildGenericBackPropagationSGD build =
                    new BuildGenericBackPropagationSGD();
        ...
        public void NN_backpropagation_generic_sgd_invalid_layer_throws_exception()
        {
            initData_dataset_gaussian_naive_bayes_jason_example();
            BuildGenericBackPropagationSGD build =
                    new BuildGenericBackPropagationSGD();
        ...
        public void NN_backpropagation_generic_sgd_missing_layer_throws_exception()
        {
            initData_dataset_gaussian_naive_bayes_jason_example();
            BuildGenericBackPropagationSGD build =
                    new BuildGenericBackPropagationSGD();
        ...
        [TestMethod]
        public void NN_backpropagation_generic_sgd_nb_all_training_samples()
        {
        ...
        [TestMethod]
        public void NN_backpropagation_generic_sgd_jason_simple_rmse()
        {
        ...
        /// </summary>
        [TestMethod]
        public void NN_backpropagation_generic_sgd_one_hidden_pythagoras_rmse()
        {
        ...
        /// </summary>
        [TestMethod]
        public void NN_backpropagation_generic_sgd_one_hidden_pythagoras_single_data_0()
        {
            Init_dataset_pythagoras();
            BuildGenericBackPropagationSGD build =
                    new BuildGenericBackPropagationSGD();
        ...
        [TestMethod]
        public void NN_backpropagation_generic_sgd_no_hidden_pythagoras_rmse()
        {
            Init_dataset_pythagoras();
            BuildGenericBackPropagationSGD build =
                    new BuildGenericBackPropagationSGD();
